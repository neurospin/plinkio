...
def bedExpand(b, trail):
    """TODO
    """
    part0=0x03; part1=0x0C; part2=0x30; part3=0xC0
    decal0=0;   decal1=2;   decal2=4;   decal3=6
    ...
    if lon:
        retval[range(0,lon*4,4)] = (b  & part0) >> decal0
        retval[range(1,lon*4,4)] = (b  & part1) >> decal1
        retval[range(2,lon*4,4)] = (b  & part2) >> decal2
        retval[range(3,lon*4,4)] = (b  & part3) >> decal3
    if trail:
